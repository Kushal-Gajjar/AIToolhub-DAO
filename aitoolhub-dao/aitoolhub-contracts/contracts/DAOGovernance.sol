...
/**
 * @title DAOGovernance
 * @notice On-chain governance for AIToolHub DAO using OpenZeppelin Governor.
 */
    ...
    GovernorTimelockControl
{
    constructor(IVotes _token, TimelockController _timelock)
        Governor("AIToolHub DAO")
        GovernorSettings(
            1,      // 1 block voting delay
            50400,  // ~1 week voting period (Polygon ~2s blocks)
            100e18  // 100 AIT proposal threshold
        )
